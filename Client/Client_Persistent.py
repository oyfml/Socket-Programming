...
def rec_file(filename):
    try:
        ...
        fd = open("./Received/P/" + filename, 'wb')
    except IOError:
    ...
    while 1:
        fd.write(data)
        if ".jpg" in filename:
            send_data(str.encode("GET /" + str(filename) +
                                 "HTTP/1.1 \r\n Host: localhost \r\n Accept: image/jpeg \r\n\r\n"))
...
def main():
    ...
    send_data(str.encode("GET /a.jpg HTTP/1.1 \r\n Host: localhost \r\n Accept: image/jpeg \r\n\r\n"))
    rec_file("a.jpg")
    print("Received file: a.jpg")
    send_data(str.encode("GET /b.mp3 HTTP/1.1 \r\n Host: localhost \r\n Accept: audio/mpeg \r\n\r\n"))
    rec_file("b.mp3")
    print("Received file: b.mp3")
    send_data(str.encode("GET /c.txt HTTP/1.1 \r\n Host: localhost \r\n Accept: text/txt \r\n\r\n"))
    rec_file("c.txt")
    print("Received file: c.txt")
